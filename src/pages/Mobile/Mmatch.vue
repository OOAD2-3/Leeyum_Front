...
<!--        title tags content pic_urls category[1] -->
	...
	            <div class="title" >
              ...
              <div class="tags" v-for="tag in item.tags"><el-tag type="info" class="tags" effect="plain">{{tag}}</el-tag></div>                   
...
<div class="leimu">
             ...
             <el-button  class="joinbutton" type="text" style="color:#fdc006;margin-right:10px;"  size="mini" round>加入</el-button>
             </div>

             <div class="matchJoinButton" v-else @click="showDetail(item)">
             <el-button  class="joinbutton" type="text" style="color:#fdc006;margin-right:10px;"  size="mini" round>详情</el-button>
             </div>
              </div>
