<template>
  <div id="root" class="root">
    ...
    <div class="intro">
      ...
      <p id="small">We provide school goods trading platform in order to enhance the value of the items.<br>The way
        items should be.</p>
      <button class="backimg" @click="$router.go(-1)"></button>
